              ...
              <div class="col-md-10">
                <div class="row">
                  ...
                  <div class="col-md-6 d-flex ">
                    <h6 class="card-title nama_mhs align-self-center h-25" style="margin-left: 15px; margin-top: 15px;">SADIRA TARUNA CALVINDORO</h6>
                  </div>
                </div> 
              </div>
            </div>
            ...
            <div class="card-body" style="border-top: 1px solid #cddfff;">
              <div class="col-md-10">
                <div class="row">
                  ...
                  <div class="col-md-6">
                    <h5 class="card-title" style="margin-left: 25px;"><b>NIM :</b> 240601201XXXXX | INFORMATIKA S1</h5>
                  </div>
                </div>
                  ...
                  <button type="button" data-bs-toggle="modal" data-bs-target="#entryIRS" style="border: none; background-color: white;">
                    <div class="card-body">
                      ...
                      <div class="d-flex" style="margin-bottom: 10px">
                        ...
                        <div class="ps-2 text-center justify-content-center">
                          <h6>ENTRY IRS</h6>
